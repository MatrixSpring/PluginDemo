package com.yty.libframe.permission;
...
public class PermissionFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //我们在permissionUtils中给fragment设置了tag 相当于缓存 已经有的重用fragment
        //调用Fragment#setRetaininstance(true)允许我们跳过销毁和重新创建的周期。指示系统保留当前的fragment实例，即使是在Activity被创新创建的时候。
